...
public interface DoubleExpression extends NumberExpression<Double>, ObservableDoubleValue
{
     ...
     */
    @Override
    public default DoubleBinding add(final double value)
    {
     ...
     */
    @Override
    public default DoubleBinding add(final ObservableNumberValue<? extends Number> other)
    {
     ...
     */
    @Override
    public default DoubleBinding divide(final double value)
    {
     ...
     */
    @Override
    public default DoubleBinding divide(final ObservableNumberValue<? extends Number> other)
    {
     ...
     */
    @Override
    public default DoubleBinding multiply(final double value)
    {
     ...
     */
    @Override
    public default DoubleBinding multiply(final ObservableNumberValue<? extends Number> other)
    {
     ...
     */
    @Override
    public default DoubleBinding subtract(final double value)
    {
     ...
     */
    @Override
    public default DoubleBinding subtract(final ObservableNumberValue<? extends Number> other)
    {
